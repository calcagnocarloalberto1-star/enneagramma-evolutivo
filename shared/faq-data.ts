// Domande frequenti sull'Enneagramma Evolutivo.
// Condiviso tra client (pagina FAQ.tsx) e server (JSON-LD FAQPage in seo-meta.ts)
// così esiste un'unica fonte di verità per questo contenuto.
